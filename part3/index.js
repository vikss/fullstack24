...
app.use(
  morgan(':url :method :status :res[content-length] - :response-time ms :data')
)
...
app.get('/api/persons', (request, response, next) => {
  console.log('Trying to get all the phonebook entries')
...
app.delete('/api/persons/:id', (request, response, next) => {
  ...
  Entry.findByIdAndDelete(id)
    .then((res) => {
      console.log('Delete document operation status: ', res)
